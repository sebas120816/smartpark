...
$usuario = "if0_41912825";
$password = "qE9ZP0gP5OT7";
$servidor = "sql308.infinityfree.com";
$basededatos = "if0_41912825_smartpark";
$puerto = 3306;
$socket = null;
...
function manejarErrorDeConexion($error_message)
{
    ...
    die("<div style='font-family: Arial, sans-serif; max-width: 760px; margin: 40px auto; padding: 24px; border: 1px solid #f1b0b7; background: #fff5f5; color: #721c24; border-radius: 8px;'>
        ...
        <p>Verifica que MySQL esté encendido en config y que la base <code>smartpark</code> exista en phpMyAdmin.</p>
    </div>");
}
